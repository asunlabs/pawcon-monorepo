...
contract Churu is ERC20, AccessControl, Pausable {
    ...
    uint256 public constant INITIAL_SUPPLY = 1000000000; // initial supply is 10 billion Churu
    ...
    constructor() ERC20("Churu", "CHR") {
        ...
        _mint(owner, INITIAL_SUPPLY); // inrease msg.sender's balance and total supply
